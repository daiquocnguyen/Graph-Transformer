...
class UGformerV1(object):
    def __init__(self, vocab_size, feature_dim_size, hparams_batch_size, ff_hidden_size, num_sampled, seq_length, num_self_att_layers, num_GNN_layers=1):
        ...
        with tf.name_scope("embedding"):
            self.embedding_matrix = tf.compat.v1.get_variable(
                    "W", shape=[vocab_size, feature_dim_size*num_GNN_layers], initializer=tf.contrib.layers.xavier_initializer())
