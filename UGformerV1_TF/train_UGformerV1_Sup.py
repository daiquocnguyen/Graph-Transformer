...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        out_dir = os.path.abspath(os.path.join(args.run_folder, "../runs_TF_UGformerV1_Sup", args.model_name))
        print("Writing to {}\n".format(out_dir))
        ...
        def train_step(input_x, graph_pool, X_concat, one_hot_labels):
            feed_dict = {
                ...
                ugformer.graph_pool: graph_pool,
                ugformer.X_concat: X_concat,
                ugformer.one_hot_labels: one_hot_labels,
        ...
        def eval_step(input_x, graph_pool, X_concat, one_hot_labels):
            feed_dict = {
                ...
                ugformer.X_concat: X_concat,
                ugformer.one_hot_labels: one_hot_labels,
                ugformer.dropout_keep_prob: 1.0
            }
            _, acc = sess.run([global_step, ugformer.accuracy], feed_dict)
            return acc
