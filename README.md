...
- 04-05-2021: Update another Pytorch implementation for training a fully-connected graph transformer, wherein we leverage the self-attention mechanism directly over all nodes of a given graph. 
